...
class WebCmsApiModelRepo {
  ...
  Future<HttpResponse> getWhoWeAre() async {
    ...
    httpClient!.client!.options = BaseOptions(contentType: Headers.formUrlEncodedContentType);
    await httpClient!
        .post(BaseUrl.notificationbaseUrl + endPoints.WebCMSApiModel().getwhoweare, body: userlogin)
        .then((responce) async {
      print(responce);
  ...
  Future<HttpResponse> getCareers() async {
    ...
    httpClient!.client!.options = BaseOptions(contentType: Headers.formUrlEncodedContentType);
    await httpClient!
        .post(BaseUrl.notificationbaseUrl + endPoints.WebCMSApiModel().getcareers, body: userlogin)
        .then((responce) async {
      print(responce);
  ...
  Future<HttpResponse> getDepartments() async {
    ...
    httpClient!.client!.options = BaseOptions(contentType: Headers.formUrlEncodedContentType);
    await httpClient!
        .post(BaseUrl.notificationbaseUrl + endPoints.WebCMSApiModel().getdepartments, body: userlogin)
        .then((responce) async {
      print(responce);
