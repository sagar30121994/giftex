...
class WebCmsApiModelRepo {
  ...
  Future<HttpResponse> getBuyDetails() async {
    ...
    await httpClient!
        .post(BaseUrl.notificationbaseUrl + endPoints.WebCMSApiModel().getbuydetails,
        body: userlogin)
        .then((responce) async {
      print(responce);
 ...
 Future<HttpResponse> getSellDetails() async {
    ...
    httpClient!.client!.options =
        BaseOptions(contentType: Headers.formUrlEncodedContentType);
    await httpClient!
        .post(BaseUrl.notificationbaseUrl + endPoints.WebCMSApiModel().getselldetails,
        body: userlogin)
        .then((responce) async {
      print(responce);
...
Future<HttpResponse> getPrivateSellDetails() async {
    ...
    httpClient!.client!.options =
        BaseOptions(contentType: Headers.formUrlEncodedContentType);
    await httpClient!
        .post(BaseUrl.notificationbaseUrl + endPoints.WebCMSApiModel().getprivateselldetails,
        body: userlogin)
        .then((responce) async {
      print(responce);
  ...
  Future<HttpResponse> getServiceDetails() async {
    ...
    httpClient!.client!.options =
        BaseOptions(contentType: Headers.formUrlEncodedContentType);
    await httpClient!
        .post(BaseUrl.notificationbaseUrl + endPoints.WebCMSApiModel().getservisedetails,
        body: userlogin)
        .then((responce) async {
      print(responce);
  ...
  Future<HttpResponse> getFaqDetails() async {
    ...
    httpClient!.client!.options =
        BaseOptions(contentType: Headers.formUrlEncodedContentType);
    await httpClient!
        .post(BaseUrl.notificationbaseUrl + endPoints.WebCMSApiModel().getfaqdetails,
        body: userlogin)
        .then((responce) async {
      print(responce);
  ...
  Future<HttpResponse> getTermsCondition() async {
    ...
    httpClient!.client!.options =
        BaseOptions(contentType: Headers.formUrlEncodedContentType);
    await httpClient!
        .post(BaseUrl.notificationbaseUrl + endPoints.WebCMSApiModel().gettermsandconditions,
        body: userlogin)
        .then((responce) async {
      print(responce);
  ...
  Future<HttpResponse> getReachUS() async {
    ...
    httpClient!.client!.options =
        BaseOptions(contentType: Headers.formUrlEncodedContentType);
    await httpClient!
        .post(BaseUrl.notificationbaseUrl + endPoints.WebCMSApiModel().getreachus,
        body: userlogin)
        .then((responce) async {
      print(responce);
  ...
  Future<HttpResponse> getWhoWeAre() async {
    ...
    httpClient!.client!.options =
        BaseOptions(contentType: Headers.formUrlEncodedContentType);
    await httpClient!
        .post(BaseUrl.notificationbaseUrl + endPoints.WebCMSApiModel().getwhoweare,
        body: userlogin)
        .then((responce) async {
      print(responce);
  ...
  Future<HttpResponse> getPressDetails() async {
    ...
    httpClient!.client!.options =
        BaseOptions(contentType: Headers.formUrlEncodedContentType);
    await httpClient!
        .post(BaseUrl.notificationbaseUrl + endPoints.WebCMSApiModel().getpressdetails,
        body: userlogin)
        .then((responce) async {
      print(responce);
  ...
  Future<HttpResponse> getCommonInfo() async {
    ...
    httpClient!.client!.options =
        BaseOptions(contentType: Headers.formUrlEncodedContentType);
    await httpClient!
        .post(BaseUrl.notificationbaseUrl + endPoints.WebCMSApiModel().getcommoninfo,
        body: userlogin)
        .then((responce) async {
      print(responce);
  ...
  Future<HttpResponse> getCareers() async {
    ...
    httpClient!.client!.options =
        BaseOptions(contentType: Headers.formUrlEncodedContentType);
    await httpClient!
        .post(BaseUrl.notificationbaseUrl + endPoints.WebCMSApiModel().getcareers,
        body: userlogin)
        .then((responce) async {
      print(responce);
  ...
  Future<HttpResponse> getBlogsDetails() async {
    ...
    httpClient!.client!.options =
        BaseOptions(contentType: Headers.formUrlEncodedContentType);
    await httpClient!
        .post(BaseUrl.notificationbaseUrl + endPoints.WebCMSApiModel().getblogdetails,
        body: userlogin)
        .then((responce) async {
      print(responce);
  ...
  Future<HttpResponse> getOurCollection() async {
    ...
    httpClient!.client!.options =
        BaseOptions(contentType: Headers.formUrlEncodedContentType);
    await httpClient!
        .post(BaseUrl.notificationbaseUrl + endPoints.WebCMSApiModel().getourcollections,
        body: userlogin)
        .then((responce) async {
      print(responce);
  ...
  Future<HttpResponse> getArtMovement() async {
    ...
    httpClient!.client!.options =
        BaseOptions(contentType: Headers.formUrlEncodedContentType);
    await httpClient!
        .post(BaseUrl.notificationbaseUrl + endPoints.WebCMSApiModel().getartmovement,
        body: userlogin)
        .then((responce) async {
      print(responce);
  ...
  Future<HttpResponse> getAuctiomGuide() async {
    ...
    httpClient!.client!.options =
        BaseOptions(contentType: Headers.formUrlEncodedContentType);
    await httpClient!
        .post(BaseUrl.notificationbaseUrl + endPoints.WebCMSApiModel().getauctionguide,
        body: userlogin)
        .then((responce) async {
      print(responce);
  ...
  Future<HttpResponse> getArtistListing() async {
    ...
    httpClient!.client!.options =
        BaseOptions(contentType: Headers.formUrlEncodedContentType);
    await httpClient!
        .post(BaseUrl.notificationbaseUrl + endPoints.WebCMSApiModel().getartistlisting,
        body: userlogin)
        .then((responce) async {
      print(responce);
  ...
  Future<HttpResponse> getArtistListingPage() async {
    ...
    httpClient!.client!.options =
        BaseOptions(contentType: Headers.formUrlEncodedContentType);
    await httpClient!
        .post(BaseUrl.notificationbaseUrl + endPoints.WebCMSApiModel().getartistlistingpage,
        body: userlogin)
        .then((responce) async {
      print(responce);
 ...
 Future<HttpResponse> getArtistProfile() async {
    ...
    httpClient!.client!.options =
        BaseOptions(contentType: Headers.formUrlEncodedContentType);
    await httpClient!
        .post(BaseUrl.notificationbaseUrl + endPoints.WebCMSApiModel().getartistprofile,
        body: userlogin)
        .then((responce) async {
      print(responce);
...
Future<HttpResponse> getNewsDetails() async {
    ...
    httpClient!.client!.options =
        BaseOptions(contentType: Headers.formUrlEncodedContentType);
    await httpClient!
        .post(BaseUrl.notificationbaseUrl + endPoints.WebCMSApiModel().getnewsdetails,
        body: userlogin)
        .then((responce) async {
      print(responce);
...
Future<HttpResponse> getFotterPage() async {
    ...
    httpClient!.client!.options =
        BaseOptions(contentType: Headers.formUrlEncodedContentType);
    await httpClient!
        .post(BaseUrl.notificationbaseUrl + endPoints.WebCMSApiModel().getfooterpage,
        body: userlogin)
        .then((responce) async {
      print(responce);
...
Future<HttpResponse> HomeMostRecentAuction() async {
    ...
    httpClient!.client!.options =
        BaseOptions(contentType: Headers.formUrlEncodedContentType);
    await httpClient!
        .post(BaseUrl.notificationbaseUrl + endPoints.WebCMSApiModel().homerecentauction,
        body: userlogin)
        .then((responce) async {
      print(responce);
...
Future<HttpResponse> HomeServices() async {
    ...
    httpClient!.client!.options =
        BaseOptions(contentType: Headers.formUrlEncodedContentType);
    await httpClient!
        .post(BaseUrl.notificationbaseUrl + endPoints.WebCMSApiModel().homeourservice,
        body: userlogin)
        .then((responce) async {
      print(responce);
...
Future<HttpResponse> HomeArtistOfMonth() async {
    ...
    httpClient!.client!.options =
        BaseOptions(contentType: Headers.formUrlEncodedContentType);
    await httpClient!
        .post(BaseUrl.notificationbaseUrl + endPoints.WebCMSApiModel().homeartistofmonth,
        body: userlogin)
        .then((responce) async {
      print(responce);
...
Future<HttpResponse> HomeCategoryOfMonth() async {
    ...
    httpClient!.client!.options =
        BaseOptions(contentType: Headers.formUrlEncodedContentType);
    await httpClient!
        .post(BaseUrl.notificationbaseUrl + endPoints.WebCMSApiModel().homecategoryofthemonth,
        body: userlogin)
        .then((responce) async {
      print(responce);
...
Future<HttpResponse> homeOurCollecter() async {
    ...
    httpClient!.client!.options =
        BaseOptions(contentType: Headers.formUrlEncodedContentType);
    await httpClient!
        .post(BaseUrl.notificationbaseUrl + endPoints.WebCMSApiModel().homeourcollecters,
        body: userlogin)
        .then((responce) async {
      print(responce);
...
Future<HttpResponse> homeNewsVideoBlog() async {
    ...
    httpClient!.client!.options =
        BaseOptions(contentType: Headers.formUrlEncodedContentType);
    await httpClient!
        .post(BaseUrl.notificationbaseUrl + endPoints.WebCMSApiModel().homenewsvideoblog,
        body: userlogin)
        .then((responce) async {
      print(responce);
...
Future<HttpResponse> homeHighlightLots() async {
    ...
    httpClient!.client!.options =
        BaseOptions(contentType: Headers.formUrlEncodedContentType);
    await httpClient!
        .post(BaseUrl.notificationbaseUrl + endPoints.WebCMSApiModel().homehighlightlot,
        body: userlogin)
        .then((responce) async {
      print(responce);
...
Future<HttpResponse> recordPriceLots() async {
    ...
    httpClient!.client!.options =
        BaseOptions(contentType: Headers.formUrlEncodedContentType);
    await httpClient!
        .post(BaseUrl.notificationbaseUrl + endPoints.WebCMSApiModel().recordpricelots,
        body: userlogin)
        .then((responce) async {
      print(responce);
...
Future<HttpResponse> getDepartments() async {
    ...
    httpClient!.client!.options =
        BaseOptions(contentType: Headers.formUrlEncodedContentType);
    await httpClient!
        .post(BaseUrl.notificationbaseUrl + endPoints.WebCMSApiModel().getdepartments,
        body: userlogin)
        .then((responce) async {
      print(responce);
...
Future<HttpResponse> getDepartmentsDetails() async {
    ...
    httpClient!.client!.options =
        BaseOptions(contentType: Headers.formUrlEncodedContentType);
    await httpClient!
        .post(BaseUrl.notificationbaseUrl + endPoints.WebCMSApiModel().getdepartmentdetails,
        body: userlogin)
        .then((responce) async {
      print(responce);
...
Future<HttpResponse> getPurchaseFaq() async {
    ...
    httpClient!.client!.options =
        BaseOptions(contentType: Headers.formUrlEncodedContentType);
    await httpClient!
        .post(BaseUrl.notificationbaseUrl + endPoints.WebCMSApiModel().getpurchasefaq,
        body: userlogin)
        .then((responce) async {
      print(responce);
...
Future<HttpResponse> getUserNotifications() async {
    ...
    httpClient!.client!.options =
        BaseOptions(contentType: Headers.formUrlEncodedContentType);
    await httpClient!
        .post(BaseUrl.notificationbaseUrl + endPoints.WebCMSApiModel().getusernotification,
        body: userlogin)
        .then((responce) async {
      print(responce);
...
Future<HttpResponse> getAuctionPage() async {
    ...
    httpClient!.client!.options =
        BaseOptions(contentType: Headers.formUrlEncodedContentType);
    await httpClient!
        .post(BaseUrl.notificationbaseUrl + endPoints.WebCMSApiModel().getauctionpage,
        body: userlogin)
        .then((responce) async {
      print(responce);
