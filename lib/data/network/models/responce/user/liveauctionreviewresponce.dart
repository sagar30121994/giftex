class LiveAuctionReviewResponce {
  String? status;
  String? message;
  Result? result;

  LiveAuctionReviewResponce({this.status, this.message, this.result});

  LiveAuctionReviewResponce.fromJson(Map<String, dynamic> json) {
    status = json['status'];
