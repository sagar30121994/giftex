class LiveAuctionReviewLotResponce {
  String? status;
  String? message;
  Result? result;

  LiveAuctionReviewLotResponce({this.status, this.message, this.result});

  LiveAuctionReviewLotResponce.fromJson(Map<String, dynamic> json) {
    status = json['status'];
