import '../liveauction/liveauctionreviewlotresponce.dart';

class GetRecordPriceArtworkResponse {
  String? status;
  String? message;
  Result? result;

  GetRecordPriceArtworkResponse({this.status, this.message, this.result});

  GetRecordPriceArtworkResponse.fromJson(Map<String, dynamic> json) {
    status = json['status'];
