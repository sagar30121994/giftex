        ...
        child: SingleChildScrollView(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                "Born in 1887 in a remote village in the state of West Bengal, Jamini Roy studied at Kolkata's Government School of Art. Initially, he painted in particular, in the Post-Impressionist genre essentially of portraits and landscapes, in keeping with his grooming as part of a proper British academic system. By 1925 though, he started to experiment along the lines of the then popular bazaar paintings synonymous with the Kalighat temple. By the 1930s, he almost completely switched over to indigenous materials for painting on woven mats, wood coated with lime and cloths. The motivation to paint on woven mats was the textures the artist noticed in Bvzantine art that he had observed in color photos. ",
                textAlign: TextAlign.center,
                style: Theme.of(context)
                    .textTheme
                    .bodyText1!
                ...
                children: [
                  Text(
                    ...
                    style: Theme.of(context)
                        .textTheme
                        .headline6!
                        .copyWith(color: Color(0xff1F1F1F), fontWeight: FontWeight.w600, letterSpacing: 2.14286),
                  ),
                ],
              ),
            ),
                                ...
                                children: [
                                  ...
                                  Text(
                                    ...
                                    style: Theme.of(context).textTheme.headline6!.copyWith(
                                        color: Colors.black, fontWeight: FontWeight.w600, letterSpacing: 1.5146),
                                  ),
                                  SizedBox(
                                    height: 10,
                                  ),
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              ...
                                              textAlign: TextAlign.center,
                                              style: Theme.of(context).textTheme.subtitle1!.copyWith(
                                                  color: Colors.black, fontWeight: FontWeight.w600, letterSpacing: 1),
                                            ),
                                            SizedBox(
                                              height: 10,
                                            ),
