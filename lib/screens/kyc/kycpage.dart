            ...
            children: [
                        ...
                        children: [
                          Text("HELLO ${widget.name}",
                              style: Theme.of(context)
                                  .textTheme
                                  .headline5!
                                  .copyWith(color: Color(0xff1F2A52), fontWeight: FontWeight.bold)),
                          SizedBox(
                            height: 16,
                          ),
                          Text(
              ...
              Text(
                ...
                style: Theme.of(context)
                    .textTheme
                    .headline6!
                    .copyWith(color: Color(0xff5D5F5C), fontWeight: FontWeight.bold),
              ),
              SizedBox(
                height: 32,
              ),
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style:
                        Theme.of(context).textTheme.subtitle2!.copyWith(color: Theme.of(context).colorScheme.primary),
                  )
                ],
              ),
              SizedBox(
              ...
              Text(
                "To get Bidding Access ",
                style: Theme.of(context).textTheme.subtitle1!.copyWith(color: Color(0xff5D5F5C)),
              ),
              SizedBox(
                height: 16,
              ),
              ...
              InkWell(
                ...
                child: Container(
                  height: 40,
                  width: 150,
                  decoration: BoxDecoration(color: Color(0xffF3E8E9), borderRadius: BorderRadius.circular(20)),
                  child: Center(
                    child: Text(
                      "Skip For Now",
                      textAlign: TextAlign.center,
