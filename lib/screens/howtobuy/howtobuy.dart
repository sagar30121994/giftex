                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      Text(
                        "${homeViewModel.getBuyDetailsResponse!.pageContent!.banner!.title ?? ''}",
                        ...
                        child: Stack(
                          children: [
                            ...
                            Positioned(
                                ...
                                bottom: 54,
                                child: Image.network(
                                  "${homeViewModel.getBuyDetailsResponse!.pageContent!.banner!.image!.mobile ?? ''}",
                                  height: 200,
                                )),
                          ],
                        ),
                      ...
                      Container(
                        ...
                        child: ExpansionTileCard(
                          ...
                          leading: Container(
                            height: 40,
                            width: 60,
                            child: Image.asset("image/reserves.png",
                                height: 40, width: 40),
                          ),
                          title: Text(
                            "RESERVES",
                      ...
                      Container(
                        ...
                        child: ExpansionTileCard(
                          ...
                          leading: Container(
                            height: 30,
                            width: 60,
                            child: Image.asset("image/margins.png",
                                height: 40, width: 40),
                          ),
                          title: Text(
                            "MARGINS",
                      ...
                      Container(
                        ...
                        child: ExpansionTileCard(
                          ...
                          leading: Container(
                            ...
                            width: 60,
                            child:
                                Image.asset("image/aftersale.png", height: 40),
                          ),
                          title: Text(
                            "AFTER SALE",
                            textAlign: TextAlign.start,
