                    ...
                    children: [
                      Padding(
                        ...
                        child: Container(
                          ...
                          // color: Color(0Xff3C5233),
                          // height: 260.0,
                          child: Image.asset("image/Rectangle (1).png",fit: BoxFit.fill,width: 200,height: 510,),
                        ),
                      ),
                      Container(
                        child:Column(
                          ...
                          children: [
                            ...
                            SizedBox(height:15,),
                            Text("Secure platform to conduct online auctions for Modern Indian and Contemporary art. ",
                              textAlign: TextAlign.start,
                              style:
                              Theme.of(context).textTheme.bodyText1!.copyWith(
                                color: Color(0XFF000000),
                            ...
                            SizedBox(height: 10,),
                            Text("AstaGuru was conceptualised in the year 2008 with the sole purpose of creating a safe . ",
                              textAlign: TextAlign.start,
                              style:
                              Theme.of(context).textTheme.bodyText1!.copyWith(
                                color: Color(0XFF000000),
                            ...
                            SizedBox(height: 16,),
                            Center(child: Image.asset("image/3.png",fit: BoxFit.fill,)),
                            SizedBox(height: 16,),
                            Container(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Container(
                          ...
                          // color: Color(0Xff3C5233),
                          // height: 260.0,
                          child: Image.asset("image/Rectangle (1).png",fit: BoxFit.fill,width: 200,height: 340,),
                        ),
                      ),
                      Padding(
                        ...
                        child: Container(
                          ...
                          // color: Color(0Xff3C5233),
                          // height: 260.0,
                          child: Image.asset("image/4.png",fit: BoxFit.fill,width: 150,height: 300,),
                        ),
                      ),
                      Padding(
                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(height: 10,),
                                    Text("ea commodo consequat. Duis aute irure dolor in ",
                                      textAlign: TextAlign.start,
                                      style:
                                      Theme.of(context).textTheme.bodyText1!.copyWith(
                                        color: Color(0XFF000000),
                      ...
                      Padding(
                        ...
                        child: Center(
                          child: Container(
                            ...
                            // color: Color(0Xff3C5233),
                            // height: 260.0,
                            child: Image.asset("image/Rectangle (1).png",fit: BoxFit.fill,width: 250,height: 510,),
                          ),
                        ),
                      ),
                      Padding(
                        ...
                        child: Column(
                          children: [
                            Container(
                              ...
                              // color: Color(0Xff3C5233),
                              // height: 260.0,
                              child: Image.asset("image/5.png",fit: BoxFit.fill,width: 200,height: 200,),
                            ),
                            // SizedBox(height: 10,),
                            Text("SEEMA VOHRA",
                              textAlign: TextAlign.end,
                            ...
                            SizedBox(height: 16,),
                            Icon(Icons.mail_outline_rounded,color: Color(0XFF000000),size: 20,),
                            SizedBox(height: 16,),
                            Text("seemavohra@astaguru.com",
                              textAlign: TextAlign.end,
                              style:
                              Theme.of(context).textTheme.bodyText1!.copyWith(
                                color: Color(0XFF000000),
