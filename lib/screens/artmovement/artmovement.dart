                    ...
                    child: Stack(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Image.asset("image/6 1.png",height: 210,),
                        ),
                        Padding(
                          padding: const EdgeInsets.only(top: 100,bottom: 0,left: 70),
                          child: Image.asset("image/7 1.png",height: 130,),
                        ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text("Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo",
                            textAlign: TextAlign.start,
                            style:
                        ...
                        Row(
                          ...
                          children: [
                            Image.asset("image/Shape (8).png",height: 20,fit: BoxFit.fill,color: Color(0xff80A071),),
                            SizedBox(width: 10,),
                            Text("HISTORY",
                              textAlign: TextAlign.start,
                              style:
                            ...
                            child: Stack(
                             children: [
                               Padding(
                                 ...
                                 child: Image.asset("image/Rectangle (4).png",width: MediaQuery.of(context).size.width*9,fit: BoxFit.cover,),
                               ),
                               Padding(
                            ...
                            child: Stack(
                              children: [
                                Padding(
                                  ...
                                  child: Image.asset("image/Rectangle 1545.png",width: MediaQuery.of(context).size.width*.6,fit: BoxFit.cover,),
                                ),
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      children: [
                                        Image.asset("image/Rectangle 1576.png",fit: BoxFit.cover,height: 150,),
                                        SizedBox(height: 16,),
                                        const SizedBox(height: 10,),
                                        Text("Suhas Bahulakr",
                                          textAlign: TextAlign.left,
                          ...
                          itemBuilder: (context, index) =>  Container(
                            ...
                            child: Stack(
                              children: [
                                Padding(
                                  padding: const EdgeInsets.only(top:100.0),
                                  child: Image.asset("image/Rectangle (13).png",fit: BoxFit.cover,height:230, width: MediaQuery.of(context).size.width*.9,),
                                ),
                                Column(
                                  children: [
                                    ...
                                    Stack(
                                      children: [
                                        ...
                                        Image.asset("image/Rectangle 2.png",fit: BoxFit.cover,height: 200, width: MediaQuery.of(context).size.width*.7,),
                                        Padding(
                                          padding: const EdgeInsets.only(top: 88.0,left:100),
                                          child: Image.asset("image/6.png",height: 45,),
                                        ),
                                        Padding(
                                        ...
                                        Padding(
                                            ...
                                            child: Image.asset("image/7.png",height: 13,)),
