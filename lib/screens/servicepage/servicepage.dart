          ...
          child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  Container(
                    width: MediaQuery.of(context).size.width*.80,
                    child: Text("WE OFFER MANY SERVICES TO \nOUR GREAT CUSTOMER",
                      textAlign: TextAlign.center,
                      style:
                      Theme.of(context).textTheme.subtitle1!.copyWith(
                        color: Color(0XFF000000),
                  ...
                  Container(
                    ...
                    child: Stack(
                      children: [
                        ...
                        Padding(
                          padding: EdgeInsets.only(left: 70,top: 100/2,),
                          child: Container(
                            //replace this Container with your Card
                            // color: Color(0Xff3C5233),
                            // height: 260.0,
                        ...
                        Padding(
                          padding: EdgeInsets.only(left: 40/2,top: 30,),
                          child: Container(
                            //replace this Container with your Card
                            // color: Color(0Xff3C5233),
                            // height: 260.0,
                  ...
                  Row(
                    ...
                    children: [
                      Container(padding: EdgeInsets.only(left: 16),
                        width: MediaQuery.of(context).size.width*.80,
                        child: Text("AstaGuru, India's premium online auction house, caters to a niche strata of clientele globally since its inception in 2008. We conduct annual auctions for an impressive range of Art and Artefacts.",
                  ...
                  Container(
                    ...
                    child: Stack(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: EdgeInsets.only(right: 70,top: 100/2,),
                          child: Container(
                            //replace this Container with your Card
                            // color: Color(0Xff3C5233),
                            // height: 260.0,
                        ...
                        Padding(
                          padding: EdgeInsets.only(right: 130,top: 90,),
                          child: Container(
                            //replace this Container with your Card
                            // color: Color(0Xff3C5233),
                            // height: 260.0,
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                        ...
                        width: MediaQuery.of(context).size.width*.80,
                        child: Text("Art is created with a soul and it is imperative that its essence resonates with the one who acquires it. We work with keen individuals to help them enrich their lives with pertinent art.",
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                        ...
                        width: MediaQuery.of(context).size.width*.80,
                        child: Text("AstaGuru reveres art in all its forms. Paintings and other artworks are susceptible to tampering and decay over the course of time. Restoration is best left to the experts, considering this service entails the longevity of the artwork.",
                          textAlign: TextAlign.start,
                          style:
                          Theme.of(context).textTheme.bodyText1!.copyWith(
                            color: Color(0XFF373737),
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                        padding: EdgeInsets.only(right: 16),
                        width: MediaQuery.of(context).size.width*.80,
                        child: Text("An artwork is only valuable if its significance is assessed keeping various parameters in mind, AstaGuru conducts a thorough research and investigates all determinant aspects, including the provenance, artist, medium, subject, authenticity, quality and the current market value.",textAlign: TextAlign.end,
                          style:
                          Theme.of(context).textTheme.bodyText1!.copyWith(
                            color: Color(0XFF373737),
                            fontWeight: FontWeight.w200,
