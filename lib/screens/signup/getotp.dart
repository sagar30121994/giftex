        ...
        body: Observer(builder: (context) {
          return Container(
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  widget.loginViewModel.isLoading ? LinearProgressIndicator() : Container(),
                  Container(
                      height: 270,
                      child: Stack(
                        children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        widget.loginResponse.result!.email == null
                            ? Container()
                            : Row(
                                children: [
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  InkWell(
                                    onTap: () async {
                                      widget.loginViewModel.getLoginWithMobile().then((value) => {
                                            if (value.status == 200)
                                              {
                                                myDuration = Duration(seconds: 95),
