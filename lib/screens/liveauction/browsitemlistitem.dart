...
class _BrowseItemListItemState extends State<BrowseItemListItem> {
                                                  ...
                                                  return Container(
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children:  <Widget>[
                                                        ...
                                                        (auctionViewModel.selectedProxyBid.trim() == "")?Container():Stack(
                                                          children: [
                                                            ...
                                                            Align(
                                                              alignment:auctionViewModel.getIndex(auctionViewModel.selectedProxyBid)==0?Alignment.topLeft:
                                                              auctionViewModel.getIndex(auctionViewModel.selectedProxyBid)==1?Alignment.topCenter:
                                                              auctionViewModel.getIndex(auctionViewModel.selectedProxyBid)==2?Alignment.topCenter:
                                                              Alignment.topRight,
                                                              child: Container(
                                                                ...
                                                                child: Text("Your Next Valid Bid ₹${formateNumber(auctionViewModel.selectedProxyBid)}",style: Theme.of(context).textTheme.subtitle1!.copyWith(color: Colors.white)),
                                                              ),
                                                            ),
      ...
      child: Container(
          ...
          child: Column(
            children: [
                  ...
                  Positioned(
                    ...
                    child: Column(
                      children: [
                        ...
                        InkWell(
                          onTap: (){
                            widget.auctionViewModel.addRemoveLotToWishlist(widget.lots,  (widget.lots.isLiked??"false") == "true"?"false":"true");
                          },
                          child: Icon(
                            (widget.lots.isLiked??"false") == "true"?Icons.favorite:Icons.favorite_border,
                            color: (widget.lots.isLiked??"false") == "true"?Colors.pink: Colors.grey,
              ...
              (hours=="00" && minutes=="00" && seconds=="00")? Align(
                alignment: Alignment.topRight,
                child: Container(
                ...
                children: [
                  ...
                  Spacer(),
                  (widget.lots.leadingUser!.id==widget.auctionViewModel.localSharedPrefrence.getUserId())?Container():ElevatedButton(
                    style: ButtonStyle(
                        backgroundColor: MaterialStateProperty.all(
                            Color(0XFFF9F9F9)),
                        shape: MaterialStateProperty.all<
                                          ...
                                          return Container(
                                            ...
                                            child: Column(
                                              ...
                                              children:  <Widget>[
                                                ...
                                                (auctionViewModel.selectedProxyBid == "")?Container():Stack(
                                                  children: [
                                                    ...
                                                    Align(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: Text("Your Next Valid Bid ₹${formateNumber(auctionViewModel.selectedProxyBid==""?"0":auctionViewModel.selectedProxyBid)}",style: Theme.of(context).textTheme.subtitle1!.copyWith(color: Colors.white)),
                                                      ),
                                                    ),
                                                ...
                                                Row(
                                                  children: [
                                                    ...
                                                    Text("I agree to",style: Theme.of(context).textTheme.subtitle2!.copyWith(color:Colors.grey),),
                                                    SizedBox(width: 2,),
                                                    Text("Terms & Conditions",style: Theme.of(context).textTheme.subtitle2!.copyWith(decoration: TextDecoration.underline,fontWeight: FontWeight.bold),),
                                                ...
                                                Padding(
                                                  padding: const EdgeInsets.all(8.0),
                                                  child: Text("If placing a proxy bid, enter the max amount you would be writing to bid upto. My Profile Page - To set your Bidding Nickname, you may submit a bid ₹25,000 (next incremental value)",textAlign: TextAlign.justify,style: Theme.of(context).textTheme.subtitle2!.copyWith(color:Colors.grey),),
                                                ),
                                                SizedBox(height: 12,),
                                            InkWell(
                                              onTap: (){
                                                ...
                                                if(checked){
                                                  if(widget.auctionViewModel.selectedProxyBid == ""){
                                                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Please Select/Enter Valid Bid",style: Theme.of(context).textTheme.subtitle2!.copyWith(color: Colors.white),),backgroundColor: Colors.red,elevation: 42,));
                                                  }else{

                                                    widget.auctionViewModel.placeBid(widget.lots,widget.auctionViewModel.selectedProxyBid,"0");

                                                    if(widget.auctionViewModel.proxyBidResponse!.status=="true"){
                                                      if(widget.auctionViewModel.proxyBidResponse!.bidStatus=="true"){
                                                        widget.auctionViewModel.selectedProxyBid = "";
                                                        Navigator.of(context).pop();

                                                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("${widget.auctionViewModel.proxyBidResponse!.bidMessage}",style: Theme.of(context).textTheme.subtitle2!.copyWith(color: Colors.white),),backgroundColor: Colors.green,elevation: 42,));
                                                      }else{
                                                        widget.auctionViewModel.selectedProxyBid = "";
                                                        Navigator.of(context).pop();

                                                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("${widget.auctionViewModel.proxyBidResponse!.bidMessage}",style: Theme.of(context).textTheme.subtitle2!.copyWith(color: Colors.white),),backgroundColor: Colors.red,elevation: 42,));
                                                      }
                                                    }else{
                                                  ...
                                                  ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Please accept Terms & Conditions",style: Theme.of(context).textTheme.subtitle2!.copyWith(color: Colors.white),),backgroundColor: Colors.red,elevation: 42,));
                                                }
                                              ...
                                              child: SizedBox(
                                                ...
                                                child: Stack(
                                                  children: [
                                                    ...
                                                    widget.auctionViewModel.isLoadingForProxy?SizedBox(
                                                        width: 240,
                                        ...
                                        return Container(
                                          ...
                                          child: Column(
                                            ...
                                            children:  <Widget>[
                                              ...
                                              SizedBox(height: 16,),
                                              Text("PLACE YOUR BID NOW",style: Theme.of(context).textTheme.headline5!.copyWith(letterSpacing: 2,fontWeight: FontWeight.bold,color: Colors.black),),
                                              SizedBox(height: 16,),
                                              // Text("My Maximum Proxy Bid",style: Theme.of(context).textTheme.subtitle1!.copyWith(letterSpacing: 2,fontWeight: FontWeight.bold),),
                                              // SizedBox(height: 16,),
                                              ...
                                              //   children: [
                                                  ...
                                                  Align(
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: Text("Your Next Valid Bid ₹${formateNumber(widget.lots.liveStatus!.nextValidBid!.iNR!)}",style: Theme.of(context).textTheme.subtitle1!.copyWith(color: Colors.white)),
                                                    ),
                                                  ),
                                              ...
                                              InkWell(
                                                onTap: (){
                                                  ...
                                                  if(checked){
                                                      ...
                                                      widget.auctionViewModel.placeBid(widget.lots,"0",widget.lots.liveStatus!.nextValidBid!.iNR!);
