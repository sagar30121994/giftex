            ...
            child: Container(
                ...
                child: Stack(
                  children: [
                    ...
                    InkWell(
                      onTap: () {
                        widget.auctionViewModel.selectedLots = widget.lots;
                                              ...
                                              (widget.lots.leadingUser!.id ==
                                                  ...
                                                  : ElevatedButton(
                                                      ...
                                                      onPressed: () async {
                                                        ...
                                                        if (auctionViewModel.getProxyBidAmountResponse!.status ==
                                                                "true" &&
                                                  ...
                                                  : InkWell(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: Center(
                                                          child: Padding(
                                                            padding: const EdgeInsets.only(
                                                                right: 24.0, left: 24, top: 12, bottom: 12),
                                                            child: Text(
                                                              'BID NOW',
                                                              style: Theme.of(context).textTheme.bodyText1!.copyWith(
