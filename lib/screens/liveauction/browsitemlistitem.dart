...
class _BrowseItemListItemState extends State<BrowseItemListItem> {
  ...
  void initState() {
    ...
    lotReference!.onValue.listen((DatabaseEvent event) {
      ...
      auctionViewModel.replaceLots(l1);
      setState(() {});
    });

    userlikeReference!.onValue.listen((DatabaseEvent event) {
      final data = event.snapshot.value;
      if (auctionViewModel.auctionType == "mygallery") {
        auctionViewModel.getLotById(widget.lots.lotId!).then((value) => {
              setState(() {}),
            });
      }
    });
    ...
    likeReference!.onValue.listen((DatabaseEvent event) {
      final data = event.snapshot.value;
      print(data);
      print(auctionViewModel.liveAuctionType);
                        ...
                        : Row(
                            ...
                            children: [
                              ...
                              (widget.lots.leadingUser!.id ==
                                      widget
                                          .auctionViewModel.localSharedPrefrence
                                          .getUserId())
                                  ? Container()
                                  : ElevatedButton(
                                      style: ButtonStyle(
