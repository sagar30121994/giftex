...
//
// class BrowsePastItemListItem extends StatefulWidget {
//   BrowsePastItemListItem(this.lots, this.grid, this.auctionViewModel);
//   Lots lots;
//   bool grid;
//   AuctionViewModel auctionViewModel;
//
//   @override
//   State<BrowsePastItemListItem> createState() => _BrowsePastItemListItemState();
// }
//
// class _BrowsePastItemListItemState extends State<BrowsePastItemListItem> {
//   @override
//   void initState() {
//     super.initState();
//   }
...
//                           child: Text(
//                               "${(widget.lots.leadingUser!.id == widget.auctionViewModel.localSharedPrefrence.getUserId()) ? "YOU WON" : "DETAILS"}",
