...
//   UpcomingAuctionItem(this.index, this.auctionViewModel, this.bottomViewModel,this.profileViewModel);
//
//   int index;
...
//               children: [
//                 Image.network(
//                   "${widget.auctionViewModel.upcomingAuctionResponse!.result!.auctions![widget.index].image}",
//                   height: 120,
//                   fit: BoxFit.contain,
//                 ),
//                 Column(
...
//                       child: Text(
//                           "${widget.auctionViewModel.upcomingAuctionResponse!.result!.auctions![widget.index].auctionName!}",
...
//                     ),
//                     Text(
//                         "${widget.auctionViewModel.upcomingAuctionResponse!.result!.auctions![widget.index].displayDate!.split(",")[0].trim()}",
//                         style: Theme.of(context)
//                             .textTheme
//                             .headline5!
...
//                     ),
//                     Text(
//                         "${widget.auctionViewModel.upcomingAuctionResponse!.result!.auctions![widget.index].displayDate!.split(",")[1].trim()}",
...
//                     InkWell(
//                       onTap: () {
//                         if ((widget.auctionViewModel.upcomingAuctionResponse!.result!.auctions![widget.index].auctionDate!) !=
//                             "TBA") {
//                           setState(() {
//                             widget.auctionViewModel.upComingLotsResponse = null;
//                             widget.auctionViewModel.selectedAuction =
//                                 widget.auctionViewModel.upcomingAuctionResponse!.result!.auctions![widget.index];
//
//                             widget.bottomViewModel.setIndex(8);
//                           });
//                         } else {
//                           showinterestPopup(widget.auctionViewModel
...
//                         child: Text(
//                           (widget.auctionViewModel.upcomingAuctionResponse!.result!.auctions![widget.index].auctionDate!) ==
//                                   "TBA"
//                               ? "SHOW INTEREST"
//                               : "EXPLORE",
...
//               // mainAxisAlignment: MainAxisAlignment.spaceAround,
//               children: [
//                 // Image.network("${widget.auctionViewModel.upcomingAuctionResponse!.result!.auctions![2].image}",height: 120,),
//                 Column(
//                   crossAxisAlignment: CrossAxisAlignment.start,
//                   children: [
//                     SizedBox(
...
//                       return widget.profileViewModel.isloading
...
//                                   ),
//                                   dropdownMenuEntries: widget.profileViewModel.getRegInfoResponse!.countryList!
