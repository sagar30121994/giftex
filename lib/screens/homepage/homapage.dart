      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Observer(
              builder: (context) {
                return homeViewModel.isLoading?CircularProgressIndicator():
                              ...
                              SizedBox(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text("${homeViewModel.homeBanerResponse!.pageContent!.banner![pos].title2}",
                                      textAlign: TextAlign.left,
                                      style:
                                    ...
                                    Container(
                                      ...
                                      child: Text("${homeViewModel.homeBanerResponse!.pageContent!.banner![pos].title3}",
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Image.network("${homeViewModel.homeBanerResponse!.pageContent!.banner![pos].image!.mobile}",fit: BoxFit.cover,height: 220,width: MediaQuery.of(context).size.width),
                                          ),
                                            SizedBox(height: 24,),
                                          SizedBox(
                                            height: 50,
                                            child: Center(
                                              child: Container(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Text('${homeViewModel.homeBanerResponse!.pageContent!.banner![pos].button!.text}', style:
                                                  Theme.of(context).textTheme.bodyText1!.copyWith(
            ...
            Observer(
              builder: (context) {
                return homeViewModel.isLoading?Container():Row(
                  children: [
                    SizedBox(width: 10,),
                    Text("0${position+1}/0${homeViewModel.homeBanerResponse!.pageContent!.banner!.length}",
                      textAlign: TextAlign.left,
                      style:
            ...
            Observer(
              builder: (context) {
                return homeViewModel.isLoadingForUpCommingAuction?LinearProgressIndicator():
                    Column(
                      children: [
                        homeViewModel.homeUpcommingAuctionResponse!.auctionArray!.length>0?     Container(
                          width: MediaQuery.of(context).size.width,
                          height: 220,
                          decoration: BoxDecoration(
                              image: DecorationImage(
                                image: NetworkImage("${homeViewModel.homeUpcommingAuctionResponse!.auctionArray![0].image}"),
                                fit: BoxFit.cover,
                 ...
                 child: Column(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    width: MediaQuery.of(context).size.width*.70,
                                    child: Text("${homeViewModel.homeUpcommingAuctionResponse!.auctionArray![0].title}",
                                      textAlign: TextAlign.start,
                                      style:
                                      Theme.of(context).textTheme.headline6!.copyWith(
                                        color: Colors.black,
                                  ...
                                  SizedBox(
                                    width: MediaQuery.of(context).size.width*.70,
                                    child: Text("${homeViewModel.homeUpcommingAuctionResponse!.auctionArray![0].displayDate}",
                                      textAlign: TextAlign.start,
                                      style:
                                      Theme.of(context).textTheme.headline6!.copyWith(
                        ...
                        homeViewModel.homeUpcommingAuctionResponse!.auctionArray!.length>1?    Container(
                          width: MediaQuery.of(context).size.width,
                          height: 220,
                          decoration: BoxDecoration(
                              image: DecorationImage(
                                image: NetworkImage("${homeViewModel.homeUpcommingAuctionResponse!.auctionArray![1].image}"),
                                fit: BoxFit.cover,
                            ...
                            children: [
                               Container(
                                 ...
                                 children: [
                                     ...
                                     SizedBox(
                                       width: MediaQuery.of(context).size.width*.70,
                                       child: Text("${homeViewModel.homeUpcommingAuctionResponse!.auctionArray![1].title}",
                                     ...
                                     SizedBox(
                                       width: MediaQuery.of(context).size.width*.70,
                                       child: Text("${homeViewModel.homeUpcommingAuctionResponse!.auctionArray![1].displayDate}",
                                         textAlign: TextAlign.end,
                                         style:
                                         Theme.of(context).textTheme.headline6!.copyWith(
                                           color: Colors.white,
        ...
        InkWell(
          ...
          child: Container(
                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          ...
                          SizedBox(height: 8,),
                          Text("Pan India \nShipping",style:Theme.of(context).textTheme.subtitle1,)
            ...
            Observer(
              builder: (context) {
                return homeViewModel.isLoadingForNews?Container(): Container(
                  color: Color(0xffFFFFFF),
                  child: DefaultTabController(
                    length: 3,
                    child:  DecoratedBox(
                  ...
                  child:  PageView.builder(
                    ...
                    itemBuilder: (BuildContext context, int pos) {
                        ...
                        child: Stack(
                          children: [
                            ...
                            Padding(
                              ...
                              child: Column(
                                children: [
                                  homeViewModel.selectedNewsTabIndex==0?  Image.network("${homeViewModel.homeNewsVideosBlogsResponse!.news![pos].image!.mobile}",fit: BoxFit.cover,height: 200):
                                  homeViewModel.selectedNewsTabIndex==1?  Image.network("${homeViewModel.homeNewsVideosBlogsResponse!.videos![pos].image!.mobile}",fit: BoxFit.cover,height: 200):
                                    Image.network("${homeViewModel.homeNewsVideosBlogsResponse!.blogs![pos].image!.mobile}",fit: BoxFit.cover,height: 200),

                                  SizedBox(height: 16,),
                                  homeViewModel.selectedNewsTabIndex==0?  Text("${homeViewModel.homeNewsVideosBlogsResponse!.news![pos].timestamp}",textAlign: TextAlign.center,
                                    style:
                                    Theme.of(context).textTheme.bodyText1!.copyWith(
                                      color: Theme.of(context).colorScheme.primary,
                                      fontWeight: FontWeight.w700,
                                  ...
                                  homeViewModel.selectedNewsTabIndex==1?  Text("${homeViewModel.homeNewsVideosBlogsResponse!.videos![pos].timestamp}",textAlign: TextAlign.center,
                                    style:
                                    Theme.of(context).textTheme.bodyText1!.copyWith(
                                      color: Theme.of(context).colorScheme.primary,
                                      fontWeight: FontWeight.w700,
                                  ...
                                  Text("${homeViewModel.homeNewsVideosBlogsResponse!.blogs![pos].timestamp}",textAlign: TextAlign.center,
                                    style:
                                    Theme.of(context).textTheme.bodyText1!.copyWith(
                                      color: Theme.of(context).colorScheme.primary,
                                      fontWeight: FontWeight.w700,
                                  ...
                                  const SizedBox(height: 10,),
                                  homeViewModel.selectedNewsTabIndex==0?   Container(
                                    child: Text("${homeViewModel.homeNewsVideosBlogsResponse!.news![pos].title}",
                                      textAlign: TextAlign.left,
                                      style:
                                      Theme.of(context).textTheme.subtitle1!.copyWith(
                                        color: Color(0xff2D2D2D),
                                  ...
                                  homeViewModel.selectedNewsTabIndex==1?  Container(
                                    child: Text("${homeViewModel.homeNewsVideosBlogsResponse!.videos![pos].title}",
                                      textAlign: TextAlign.left,
                                      style:
                                      Theme.of(context).textTheme.subtitle1!.copyWith(
                                        color: Color(0xff2D2D2D),
                                  ...
                                  Container(
                                    child: Text("${homeViewModel.homeNewsVideosBlogsResponse!.blogs![pos].title}",
                                      textAlign: TextAlign.left,
                                      style:
                                      Theme.of(context).textTheme.subtitle1!.copyWith(
                                        color: Color(0xff2D2D2D),
                                  ...
                                  const SizedBox(height: 10,),
                                  homeViewModel.selectedNewsTabIndex==0?   Text("${homeViewModel.homeNewsVideosBlogsResponse!.news![pos].desc}",
                      textAlign: TextAlign.left,
                      overflow:TextOverflow.ellipsis,
                      maxLines: 2,
                      style:
                      ...
                      fontWeight: FontWeight.w400,
                                  ...
                                  homeViewModel.selectedNewsTabIndex==1?   Text("${homeViewModel.homeNewsVideosBlogsResponse!.videos![pos].desc}",
                      textAlign: TextAlign.left,
                      overflow:TextOverflow.ellipsis,
                      maxLines: 2,
                      style:
                      ...
                      Text("${homeViewModel.homeNewsVideosBlogsResponse!.blogs![pos].desc}",
                      textAlign: TextAlign.left,
                      overflow:TextOverflow.ellipsis,
                      maxLines: 2,
                      style:
