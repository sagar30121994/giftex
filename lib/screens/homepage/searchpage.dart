                        ...
                        onPressed: () {
                          setState(() {
                            if (searchController.text.length >= 3) {
                              auctionViewModel.SearchGlobalauctions(
                                  searchController.text);
                            } else {
                              auctionViewModel.newsearchResponse = null;
                            }
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      InkWell(
                                                                        onTap:
                                                                          ...
                                                                          Navigator.push(
                                                                              context,
                                                                              MaterialPageRoute(builder: (context) => ImageConponent(e.images!.cast<Images>())));
                                                                        },
                                                                        child:
                                                                            Icon(
                                                                          Icons
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    InkWell(
                                                                      onTap:
                                                                        ...
                                                                        Navigator.push(
                                                                            context,
                                                                            MaterialPageRoute(builder: (context) => ProductDetailPage(e, auctionViewModel)));
                                                                      },
                                                                      child:
                                                                          Padding(
                                                                        padding:
