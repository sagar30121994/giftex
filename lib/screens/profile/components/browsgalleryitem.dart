...
class BrowseGalleryListItem extends StatefulWidget {
  BrowseGalleryListItem(this.lots, this.grid, this.auctionViewModel);
  Lots lots;
  bool grid;
  AuctionViewModel auctionViewModel;

  @override
  State<BrowseGalleryListItem> createState() => _BrowseGalleryListItemState();
}

class _BrowseGalleryListItemState extends State<BrowseGalleryListItem> with AutomaticKeepAliveClientMixin {
