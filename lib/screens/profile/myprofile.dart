...
class _MyProfilepageState extends State<MyProfilepage> {
  ...
  void initState() {
   ...
   nameController.text="${(widget.getUserAllDetailsResponse!.result!.profile!.basicDetails!.firstName??'')} ${(widget.getUserAllDetailsResponse!.result!.profile!.basicDetails!.lastName??'')}";
   ...
   nationalityController.text="${(widget.getUserAllDetailsResponse!.result!.profile!.basicDetails!.nationality??'')}";
                    ...
                    children: [
                      Stack(
                        ...
                        children: [
                          ...
                          CircleAvatar(
                            radius: 37,
                            backgroundImage: NetworkImage('${baseUrl+(widget.getUserAllDetailsResponse!.result!.profile!.basicDetails!.profilePicUrl??'')}'),
                                ...
                                children: [
                                  RichText(
                                    ...
                                    text: TextSpan(
                                      ...
                                      children: <TextSpan>[
                                        ...
                                        TextSpan(text: '${(widget.getUserAllDetailsResponse!.result!.profile!.basicDetails!.firstName??'')}', style:  Theme.of(context).textTheme.headline6!.copyWith(
                                          color: Colors.black,
                                          fontWeight: FontWeight.bold,),),
                                      ],
                                    ),
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      SizedBox(width: 3,),
                                      Text('${(widget.getUserAllDetailsResponse!.result!.profile!.address!.first!.city??'')}',
                                        textAlign: TextAlign.center,
                                        style:
                                    ...
                                    Expanded(
                                      child: Row(
                                        ...
                                        children: [
                                          Expanded(
                                            flex: 3,
                                            child: Text("${widget.getUserAllDetailsResponse!.result!.profile!.address?[index].type??''}",
                                          ...
                                          Flexible(
                                              flex: 1,
                                              child: Image.asset("image/oredit.png",height: 18,)
                                          ),
                                          // Icon(Icons.edit,size: 20,color: Color(0xff747474),),
                                          SizedBox(width: 5,),
                                          Flexible(
                                              flex: 1,
                                              child: Image.asset("image/updelete.png",height: 18,)
                                          ),
