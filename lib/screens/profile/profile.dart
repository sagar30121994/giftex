                                    ...
                                    children: [
                                      RichText(
                                        ...
                                        text: TextSpan(
                                          ...
                                          children: <TextSpan>[
                                            ...
                                            TextSpan(text: '${profileViewModel.getUserAllDetailsResponse!.result!.profile!.basicDetails!.firstName??''}', style:  Theme.of(context).textTheme.headline6!.copyWith(
                                              color: Colors.black,
                                              fontWeight: FontWeight.bold,),),
                                          ],
                                        ),
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          SizedBox(width: 3,),
                                          Text('${profileViewModel.getUserAllDetailsResponse!.result!.profile!.address!.first.city??''},${profileViewModel.getUserAllDetailsResponse!.result!.profile!.address!.first.country??''}',
                                            textAlign: TextAlign.center,
                                            style:
                          ...
                          Padding(
                            ...
                            child: Column(
                              children: [
                                InkWell(
                                  onTap: (){
                                    Navigator.push(context, MaterialPageRoute(builder: (context) => MyProfilepage(profileViewModel.getUserAllDetailsResponse!)));
                                  },
                                  child: Row(
                                    children: [
