                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                       ...
                       SizedBox(height: 16,),
                        Text("Order Delivered : 24/09/2022",
                          textAlign: TextAlign.center,
                          style:
                          Theme.of(context).textTheme.subtitle1!.copyWith(
                            color: Color(0xff2D2D2D),
                  ...
                  Stack(
                    children: [
                      Padding(
                        ...
                        child: Image.asset("image/Rectangle (8).png",fit: BoxFit.cover, height:140, width: MediaQuery.of(context).size.width,),
                      ),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.start,
                        crossAxisAlignment: CrossAxisAlignment.start,
                    ...
                    children: [
                      ElevatedButton(
                        ...
                        child: Padding(
                          ...
                          child: Text('DOWNLOAD INVOICE', style:
                          Theme.of(context).textTheme.caption!.copyWith(
                      ...
                      ElevatedButton(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.only(right: 0.0,left: 0,top: 12,bottom: 12),
                          child: Text('WRITE A REVIEW', style:
                          Theme.of(context).textTheme.caption!.copyWith(
