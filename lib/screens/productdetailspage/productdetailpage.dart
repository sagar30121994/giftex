...
class _ProductDetailPageState extends State<ProductDetailPage> with AutomaticKeepAliveClientMixin {
  ...
  startTimerForSlider() {
    timerForTimer = Timer.periodic(Duration(seconds: 4), (_) async {
      setState(() {
        if (widget.lots.images == null) {} else {
                ...
                children: [
                  ...
                  widget.lots.status!.toLowerCase() == "upcoming"
                    ...
                    children: [
                      ...
                      : Text(
                    '₹${formateNumber(widget.lots.estimateFrom!.iNR ?? "0")} - ₹${formateNumber(widget.lots.estimateTo!
                        .iNR ?? "")}',
                    style: Theme
                        .of(context)
                        .textTheme
                  ...
                  Observer(builder: (context) {
                    return widget.auctionViewModel.auctionType == "past"
                      ...
                      children: [
                        ...
                        : InkWell(
                      onTap: () {
                        if (preference!.getLoginStatus()) {} else {
                          WidgetsBinding.instance?.addPostFrameCallback((_) {
                            showDialog(
                              context: context,
                              builder: (BuildContext context) {
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              "₹${formateNumber(
                                  (widget.lots!.proxyStatus == null ? '0' : widget.lots!.proxyStatus!.proxyAmount!
                                      .iNR ?? "0"))}",
                              textAlign: TextAlign.center,
                              style: Theme
                                  .of(context)
                                            ...
                                            children: [
                                              Row(
                                                children: [
                                                  ...
                                                  Text(
                                                    '₹ ${formateNumber(
                                                        widget.auctionViewModel.additionalChargeResponse!.result!.price!
                                                            .iNR!)}',
                                                    style: Theme
                                                        .of(context)
                                                        .textTheme
                                              ...
                                              Row(
                                                children: [
                                                  Text(
                                                    '${widget.auctionViewModel.additionalChargeResponse!.result!
                                                        .taxation![0].name}',
                                                    style: Theme
                                                        .of(context)
                                                        .textTheme
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  Text(
                                                    '₹ ${formateNumber(
                                                        widget.auctionViewModel.additionalChargeResponse!.result!.total!
                                                            .iNR!)}',
                                                    style: Theme
                                                        .of(context)
                                                        .textTheme
                                                ...
                                                Align(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    decoration: BoxDecoration(
                                                        ...
                                                        borderRadius: BorderRadius.circular(8)),
                                                    child: Text(
                                                        "Your Next Valid Bid ₹${formateNumber(
                                                            widget.auctionViewModel.selectedProxyBid == ""
                                                                ? "0"
                                                                : widget.auctionViewModel.selectedProxyBid)}",
                                                        style: Theme
                        ...
                        child: Container(
                          ...
                          child: Text(
                              "${(widget.lots.leadingUser!.id ==
                                  widget.auctionViewModel.localSharedPrefrence.getUserId()) ? "YOU WON" : widget.lots
                                  .bidCount == "0" ? "BOUGHT IN" : "BID CLOSED"}",
                              style: Theme
                                  .of(context)
                                  .textTheme
                                  .subtitle2!
