...
class _ProductDetailPageState extends State<ProductDetailPage> {
  ...
  void initData() {
    ...
    widget.auctionViewModel.getLotById(widget.lots.lotId!).then((value) => {
          setState(() {
                                    ...
                                    child: Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Image.network("${widget.lots.images![pos].bigImage}",
                                            fit: BoxFit.contain, height: 220, width: MediaQuery.of(context).size.width),
                                      ),
                                    ),
                                  ),
                                ),
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                                    ...
                                    children: [
                                      ...
                                      (hours == "00" && minutes == "00" && seconds == "00")
                                          ...
                                          : ElevatedButton(
                                              ...
                                              child: Padding(
                                                padding:
                                                    const EdgeInsets.only(right: 5.0, left: 5, top: 10, bottom: 10),
                                                child: Text(
                            ...
                            ? Align(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      borderRadius: BorderRadius.circular(16)),
                                  child: Text(
                                      "${(widget.lots.leadingUser!.id == widget.auctionViewModel.localSharedPrefrence.getUserId()) ? "YOU OWN" : widget.lots.bidCount != "0" ? "BOUGHT IN" : "THIS BID IS CLOSED"}",
                                      style: Theme.of(context).textTheme.subtitle2!.copyWith(color: Colors.white)),
                                ),
                              )
                            : widget.lots.status!.toLowerCase() == "live"
                                      ...
                                      (widget.lots.leadingUser!.id ==
                                          ...
                                          : ElevatedButton(
                                              ...
                                              onPressed: () async {
                                                ...
                                                if (widget.auctionViewModel.getProxyBidAmountResponse!.status ==
                                                    "true") {
                                                                  ...
                                                                  (widget.auctionViewModel.selectedProxyBid == "")
                                                                      ...
                                                                      : Stack(
                                                                          children: [
                                                                            Positioned(
                                                                                top: 0,
                                                                                left: widget.auctionViewModel.getIndex(
                                                                                            widget.auctionViewModel
                                                                                                .selectedProxyBid) ==
                                                                                        0
                                                                                    ? 42
                                                                            ...
                                                                            Align(
                                                                              alignment: widget.auctionViewModel
                                                                                          .getIndex(widget
                                                                                              .auctionViewModel
                                                                                              .selectedProxyBid) ==
                                                                                      0
                                              ...
                                              child: Padding(
                                                padding:
                                                    const EdgeInsets.only(right: 8.0, left: 8, top: 12, bottom: 12),
                                                child: Text(
                                                  'PROXY BID',
                                                  style: Theme.of(context).textTheme.bodyText1!.copyWith(
                                                        color: Color(0XFF2D2D2D),
                                          ...
                                          : InkWell(
                                              ...
                                              child: Container(
                                                ...
                                                child: Center(
                                                  child: Padding(
                                                    padding: const EdgeInsets.only(
                                                        right: 16.0, left: 16, top: 12, bottom: 12),
                                                    child: Text(
                                                      'BID NOW',
                                                      style: Theme.of(context).textTheme.bodyText1!.copyWith(
                                                            color: Color(0XFFFFFFFF),
                        ...
                        //                         crossAxisAlignment: CrossAxisAlignment.center,
                        //                         children: [
                        //                           Image.asset("image/Vector (3).png",
                        //                               height: 25, width: 25, color: Theme.of(context).colorScheme.primary),
                        //                           SizedBox(
                        //                             width: 10,
                        //                           ),
                        //                           Container(
                        ...
                        //                 Container(
                        //                   decoration: BoxDecoration(
                        //                       borderRadius: BorderRadius.circular(16), color: Color(0xffEAF1DB)),
                        //                   padding: EdgeInsets.symmetric(horizontal: 10, vertical: 4),
                        //                   child: Text("5 BIDS"),
                        //                 ),
                        //                 SizedBox(height: 12),
