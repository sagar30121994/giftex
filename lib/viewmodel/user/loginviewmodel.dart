...
abstract class _LoginViewModel with Store {
  ...
  Future<HttpResponse> getLoginWithMobile() async {
    ...
    HttpResponse httpResponse = await orderRepo!.loginMobile(LoginReqestModel(
        countryCode: "91", mobile: mobile, authkeyMobile: "", authkeyWeb: "", deviceCode: "", email: "", fcmTockenMobile: "", fcmTockenWebsite: "", loginFrom: "Website", password: "", userid: ""));
  ...
  Future<HttpResponse> getLoginWithEmailPass() async {
    ...
    HttpResponse httpResponse = await orderRepo!.loginMobile(LoginReqestModel(
        countryCode: "", mobile: "", authkeyMobile: "", authkeyWeb: "", deviceCode: "", email: email, fcmTockenMobile: "", fcmTockenWebsite: "", loginFrom: "Website", password: pass, userid: ""));
